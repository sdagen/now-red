...
for idx = 1:numel(seedPlans)
    evaluation = evaluateMissionPlan(seedPlans(idx), ...
        Model=options.Model, ...
        Runs=options.RunsPerCandidate, ...
        SeedNorthBase=options.SeedNorthBase, ...
        SeedSouthBase=options.SeedSouthBase, ...
        DryHoursWeight=options.DryHoursWeight, ...
        LostTonsWeight=options.LostTonsWeight, ...
        KillsWeight=options.KillsWeight, ...
        DeliveryReward=options.DeliveryReward);
    row = row + 1;
...
for iter = 1:nIterations
    ...
    evaluation = evaluateMissionPlan(candidate, ...
        Model=options.Model, ...
        Runs=options.RunsPerCandidate, ...
        SeedNorthBase=options.SeedNorthBase, ...
        SeedSouthBase=options.SeedSouthBase, ...
